...
def translate_sources():
    ...
    # simplified names
    QCoreApplication.translate("Subjects", "CHN")
    QCoreApplication.translate("Subjects", "Math")
    QCoreApplication.translate("Subjects", "Eng")
    QCoreApplication.translate("Subjects", "Civics")
    QCoreApplication.translate("Subjects", "Hist")
    QCoreApplication.translate("Subjects", "Phys")
    QCoreApplication.translate("Subjects", "Chem")
    QCoreApplication.translate("Subjects", "Bio")
    QCoreApplication.translate("Subjects", "Geo")
    QCoreApplication.translate("Subjects", "Mus")
    QCoreApplication.translate("Subjects", "Art")
    QCoreApplication.translate("Subjects", "Psy")
    QCoreApplication.translate("Subjects", "PE")
    QCoreApplication.translate("Subjects", "IT")
    QCoreApplication.translate("Subjects", "GenTech")
    QCoreApplication.translate("Subjects", "Elective")
    QCoreApplication.translate("Subjects", "Study")
    QCoreApplication.translate("Subjects", "Club")
    QCoreApplication.translate("Subjects", "ClassMtg")
    QCoreApplication.translate("Subjects", "Weekly")
    QCoreApplication.translate("Subjects", "Econ")
    QCoreApplication.translate("Subjects", "Philos")
    QCoreApplication.translate("Subjects", "CS")
